...
import pers.qingyu.sachima.sql.dialect.mysql.ast.MySqlForceIndexHint;
import pers.qingyu.sachima.sql.dialect.mysql.ast.MySqlIgnoreIndexHint;
import pers.qingyu.sachima.sql.dialect.mysql.ast.MySqlKey;
import pers.qingyu.sachima.sql.dialect.mysql.ast.MySqlPrimaryKey;
import pers.qingyu.sachima.sql.dialect.mysql.ast.MySqlUnique;
import pers.qingyu.sachima.sql.dialect.mysql.ast.MySqlUseIndexHint;
import pers.qingyu.sachima.sql.dialect.mysql.ast.MysqlForeignKey;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlCaseStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlCaseStatement.MySqlWhenStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlCursorDeclareStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlDeclareConditionStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlDeclareHandlerStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlDeclareStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlIterateStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlLeaveStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlRepeatStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.clause.MySqlSelectIntoStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.expr.MySqlCharExpr;
import pers.qingyu.sachima.sql.dialect.mysql.ast.expr.MySqlJSONTableExpr;
import pers.qingyu.sachima.sql.dialect.mysql.ast.expr.MySqlOrderingExpr;
import pers.qingyu.sachima.sql.dialect.mysql.ast.expr.MySqlOutFileExpr;
import pers.qingyu.sachima.sql.dialect.mysql.ast.expr.MySqlUserName;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.CobarShowStatus;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsBaselineStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsCancelDDLJob;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsChangeDDLJob;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsClearDDLJobCache;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsInspectDDLJobCache;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsRecoverDDLJob;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsRemoveDDLJob;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsRollbackDDLJob;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsShowDDLJobs;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsShowGlobalIndex;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.DrdsShowMetadataLock;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterDatabaseKillJob;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterDatabaseSetOption;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterEventStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterLogFileGroupStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterServerStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableAlterColumn;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableAlterFullTextIndex;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableChangeColumn;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableDiscardTablespace;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableForce;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableImportTablespace;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableLock;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableModifyColumn;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableOption;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableOrderBy;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTableValidation;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterTablespaceStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAlterUserStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlAnalyzeStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlBinlogStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCheckTableStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlChecksumTableStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlClearPlanCacheStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateAddLogFileGroupStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateEventStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateExternalCatalogStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateServerStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateTableSpaceStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateTableStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlCreateUserStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlDeleteStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlDisabledPlanCacheStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlEventSchedule;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlExecuteForAdsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlExecuteStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlExplainPlanCacheStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlExplainStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlExtPartition;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlFlashbackStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlFlushStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlHelpStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlHintStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlInsertStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlLoadDataInFileStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlLoadXmlStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlLockTableStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlManageInstanceGroupStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlMigrateStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlOptimizeStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlPartitionByKey;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlPrepareStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlRaftLeaderTransferStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlRaftMemberChangeStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlRenameSequenceStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlRenameTableStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlResetStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlSelectQueryBlock;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlSetTransactionStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowAuthorsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowBinLogEventsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowBinaryLogsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowBroadcastsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCharacterSetStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowClusterNameStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCollationStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowConfigStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowContributorsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCreateDatabaseStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCreateEventStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCreateFunctionStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCreateProcedureStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowCreateTriggerStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowDatabaseStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowDatasourcesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowDdlStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowDsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowEngineStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowEnginesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowErrorsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowEventsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowFunctionCodeStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowFunctionStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowGrantsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowHMSMetaStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowHelpStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowJobStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowMasterLogsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowMasterStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowMigrateTaskStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowNodeStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowOpenTablesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowPartitionsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowPhysicalProcesslistStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowPlanCacheStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowPlanCacheStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowPluginsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowPrivilegesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowProcedureCodeStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowProcedureStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowProcessListStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowProfileStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowProfilesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowRelayLogEventsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowRuleStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowRuleStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowSequencesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowSlaveHostsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowSlaveStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowSlowStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowTableStatusStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowTopologyStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowTraceStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowTriggersStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowVariantsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlShowWarningsStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlSubPartitionByKey;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlSubPartitionByList;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlSubPartitionByValue;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlTableIndex;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlUnlockTablesStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlUpdatePlanCacheStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlUpdateStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlUpdateTableSource;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlAlterFullTextStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlAlterTableAlterCheck;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlCreateFullTextAnalyzerStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlCreateFullTextCharFilterStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlCreateFullTextDictionaryStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlCreateFullTextTokenFilterStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlCreateFullTextTokenizerStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlDeallocatePrepareStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlDropFullTextStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlShowCreateFullTextStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlShowDbLockStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlShowFullTextStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlShowHtcStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MysqlShowStcStatement;
