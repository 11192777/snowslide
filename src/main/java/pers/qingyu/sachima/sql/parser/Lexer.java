...
import pers.qingyu.sachima.sql.dialect.mysql.parser.MySqlLexer;
import pers.qingyu.sachima.util.FnvHash;
...
import static pers.qingyu.sachima.sql.parser.CharTypes.isFirstIdentifierChar;
import static pers.qingyu.sachima.sql.parser.CharTypes.isIdentifierChar;
import static pers.qingyu.sachima.sql.parser.CharTypes.isWhitespace;
import static pers.qingyu.sachima.sql.parser.LayoutCharacters.EOI;
import static pers.qingyu.sachima.sql.parser.SQLParserFeature.KeepComments;
import static pers.qingyu.sachima.sql.parser.SQLParserFeature.KeepSourceLocation;
import static pers.qingyu.sachima.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static pers.qingyu.sachima.sql.parser.SQLParserFeature.SkipComments;
import static pers.qingyu.sachima.sql.parser.Token.*;
import static pers.qingyu.sachima.sql.parser.Token.COLON;
import static pers.qingyu.sachima.sql.parser.Token.COLONCOLON;
import static pers.qingyu.sachima.sql.parser.Token.COLONEQ;
import static pers.qingyu.sachima.sql.parser.Token.COMMA;
import static pers.qingyu.sachima.sql.parser.Token.DOT;
import static pers.qingyu.sachima.sql.parser.Token.EOF;
import static pers.qingyu.sachima.sql.parser.Token.EQ;
import static pers.qingyu.sachima.sql.parser.Token.EQEQ;
import static pers.qingyu.sachima.sql.parser.Token.EQGT;
import static pers.qingyu.sachima.sql.parser.Token.ERROR;
import static pers.qingyu.sachima.sql.parser.Token.IDENTIFIER;
import static pers.qingyu.sachima.sql.parser.Token.LBRACE;
import static pers.qingyu.sachima.sql.parser.Token.LBRACKET;
import static pers.qingyu.sachima.sql.parser.Token.LITERAL_ALIAS;
import static pers.qingyu.sachima.sql.parser.Token.LITERAL_CHARS;
import static pers.qingyu.sachima.sql.parser.Token.LITERAL_PATH;
import static pers.qingyu.sachima.sql.parser.Token.LPAREN;
import static pers.qingyu.sachima.sql.parser.Token.RBRACE;
import static pers.qingyu.sachima.sql.parser.Token.RBRACKET;
