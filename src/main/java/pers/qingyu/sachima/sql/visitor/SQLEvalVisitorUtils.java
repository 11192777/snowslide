...
import pers.qingyu.sachima.exception.FastsqlException;
...
import pers.qingyu.sachima.sql.ast.expr.SQLValuableExpr;
...
import pers.qingyu.sachima.sql.dialect.mysql.visitor.MySqlEvalVisitorImpl;
import pers.qingyu.sachima.sql.dialect.oracle.visitor.OracleEvalVisitor;
import pers.qingyu.sachima.sql.visitor.functions.Ascii;
import pers.qingyu.sachima.sql.visitor.functions.Bin;
import pers.qingyu.sachima.sql.visitor.functions.BitLength;
import pers.qingyu.sachima.sql.visitor.functions.Char;
import pers.qingyu.sachima.sql.visitor.functions.Concat;
import pers.qingyu.sachima.sql.visitor.functions.DateAdd;
import pers.qingyu.sachima.sql.visitor.functions.Elt;
import pers.qingyu.sachima.sql.visitor.functions.Function;
import pers.qingyu.sachima.sql.visitor.functions.Greatest;
import pers.qingyu.sachima.sql.visitor.functions.Hex;
import pers.qingyu.sachima.sql.visitor.functions.If;
import pers.qingyu.sachima.sql.visitor.functions.Insert;
import pers.qingyu.sachima.sql.visitor.functions.Instr;
import pers.qingyu.sachima.sql.visitor.functions.Isnull;
import pers.qingyu.sachima.sql.visitor.functions.Lcase;
import pers.qingyu.sachima.sql.visitor.functions.Least;
import pers.qingyu.sachima.sql.visitor.functions.Left;
import pers.qingyu.sachima.sql.visitor.functions.Length;
import pers.qingyu.sachima.sql.visitor.functions.Locate;
import pers.qingyu.sachima.sql.visitor.functions.Lpad;
import pers.qingyu.sachima.sql.visitor.functions.Ltrim;
import pers.qingyu.sachima.sql.visitor.functions.Now;
import pers.qingyu.sachima.sql.visitor.functions.OneParamFunctions;
import pers.qingyu.sachima.sql.visitor.functions.Reverse;
import pers.qingyu.sachima.sql.visitor.functions.Right;
import pers.qingyu.sachima.sql.visitor.functions.Substring;
import pers.qingyu.sachima.sql.visitor.functions.ToChar;
import pers.qingyu.sachima.sql.visitor.functions.ToDate;
import pers.qingyu.sachima.sql.visitor.functions.Trim;
import pers.qingyu.sachima.sql.visitor.functions.Ucase;
import pers.qingyu.sachima.sql.visitor.functions.Unhex;
import pers.qingyu.sachima.util.HexBin;
import pers.qingyu.sachima.util.Utils;
...
import static pers.qingyu.sachima.sql.visitor.SQLEvalVisitor.EVAL_ERROR;
import static pers.qingyu.sachima.sql.visitor.SQLEvalVisitor.EVAL_EXPR;
import static pers.qingyu.sachima.sql.visitor.SQLEvalVisitor.EVAL_VALUE;
import static pers.qingyu.sachima.sql.visitor.SQLEvalVisitor.EVAL_VALUE_NULL;
