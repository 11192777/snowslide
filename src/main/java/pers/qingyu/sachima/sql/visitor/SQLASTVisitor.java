 ...
 */
package pers.qingyu.sachima.sql.visitor;

import pers.qingyu.sachima.sql.ast.expr.SQLTempExpr;
import pers.qingyu.sachima.sql.ast.SQLAdhocTableSource;
import pers.qingyu.sachima.sql.ast.SQLAnnIndex;
import pers.qingyu.sachima.sql.ast.SQLArgument;
import pers.qingyu.sachima.sql.ast.SQLArrayDataType;
import pers.qingyu.sachima.sql.ast.SQLCommentHint;
import pers.qingyu.sachima.sql.ast.SQLCurrentTimeExpr;
import pers.qingyu.sachima.sql.ast.SQLCurrentUserExpr;
import pers.qingyu.sachima.sql.ast.SQLDataType;
import pers.qingyu.sachima.sql.ast.SQLDataTypeRefExpr;
import pers.qingyu.sachima.sql.ast.SQLDeclareItem;
import pers.qingyu.sachima.sql.ast.SQLIndexDefinition;
import pers.qingyu.sachima.sql.ast.SQLIndexOptions;
import pers.qingyu.sachima.sql.ast.SQLKeep;
import pers.qingyu.sachima.sql.ast.SQLLimit;
import pers.qingyu.sachima.sql.ast.SQLMapDataType;
import pers.qingyu.sachima.sql.ast.SQLObject;
import pers.qingyu.sachima.sql.ast.SQLOrderBy;
import pers.qingyu.sachima.sql.ast.SQLOver;
import pers.qingyu.sachima.sql.ast.SQLParameter;
import pers.qingyu.sachima.sql.ast.SQLPartition;
import pers.qingyu.sachima.sql.ast.SQLPartitionByHash;
import pers.qingyu.sachima.sql.ast.SQLPartitionByList;
import pers.qingyu.sachima.sql.ast.SQLPartitionByRange;
import pers.qingyu.sachima.sql.ast.SQLPartitionByValue;
import pers.qingyu.sachima.sql.ast.SQLPartitionSpec;
import pers.qingyu.sachima.sql.ast.SQLPartitionValue;
import pers.qingyu.sachima.sql.ast.SQLRecordDataType;
import pers.qingyu.sachima.sql.ast.SQLRowDataType;
import pers.qingyu.sachima.sql.ast.SQLStructDataType;
import pers.qingyu.sachima.sql.ast.SQLSubPartition;
import pers.qingyu.sachima.sql.ast.SQLSubPartitionByHash;
import pers.qingyu.sachima.sql.ast.SQLSubPartitionByList;
import pers.qingyu.sachima.sql.ast.SQLSubPartitionByRange;
import pers.qingyu.sachima.sql.ast.SQLUnionDataType;
import pers.qingyu.sachima.sql.ast.SQLWindow;
import pers.qingyu.sachima.sql.ast.SQLZOrderBy;
import pers.qingyu.sachima.sql.ast.expr.SQLAggregateExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLAllColumnExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLAllExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLAnyExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLArrayExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLBetweenExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLBigIntExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLBinaryExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLBinaryOpExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLBinaryOpExprGroup;
import pers.qingyu.sachima.sql.ast.expr.SQLBooleanExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLCaseExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLCaseStatement;
import pers.qingyu.sachima.sql.ast.expr.SQLCastExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLCharExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLContainsExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLCurrentOfCursorExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLDateExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLDateTimeExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLDbLinkExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLDecimalExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLDefaultExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLDoubleExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLExistsExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLExtractExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLFlashbackExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLFloatExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLGroupingSetExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLHexExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLIdentifierExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLInListExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLInSubQueryExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLIntegerExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLIntervalExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLJSONExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLListExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLMatchAgainstExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLMethodInvokeExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLNCharExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLNotExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLNullExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLNumberExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLPropertyExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLQueryExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLRealExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLSequenceExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLSizeExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLSmallIntExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLSomeExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLTimeExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLTimestampExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLTinyIntExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLUnaryExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLValuesExpr;
import pers.qingyu.sachima.sql.ast.expr.SQLVariantRefExpr;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterCharacter;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterDatabaseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterFunctionStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterIndexStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterMaterializedViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterOutlineStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterProcedureStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterSequenceStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterSystemGetConfigStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterSystemSetConfigStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddClusteringKey;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddColumn;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddConstraint;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddExtPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddIndex;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAddSupplemental;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAlterColumn;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAlterIndex;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableAnalyzePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableArchivePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableBlockSize;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableCheckPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableCoalescePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableCompression;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableConvertCharSet;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDeleteByCondition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDisableConstraint;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDisableKeys;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDisableLifecycle;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDiscardPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropClusteringKey;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropColumnItem;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropConstraint;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropExtPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropForeignKey;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropIndex;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropKey;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropPrimaryKey;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableDropSubpartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableEnableConstraint;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableEnableKeys;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableEnableLifecycle;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableExchangePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableGroupStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableImportPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableMergePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableModifyClusteredBy;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableOptimizePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTablePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTablePartitionCount;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTablePartitionLifecycle;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTablePartitionSetProperties;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableReOrganizePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRebuildPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRecoverPartitions;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRename;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRenameColumn;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRenameIndex;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRenamePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableRepairPartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableReplaceColumn;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableSetComment;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableSetLifecycle;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableSetLocation;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableSetOption;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableSubpartitionAvailablePartitionNum;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableSubpartitionLifecycle;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableTouch;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableTruncatePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTableUnarchivePartition;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterTypeStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterViewRenameStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAlterViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAnalyzeTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLArchiveTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLAssignItem;
import pers.qingyu.sachima.sql.ast.statement.SQLBackupStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLBlockStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLBuildTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCallStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCancelJobStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCharacterDataType;
import pers.qingyu.sachima.sql.ast.statement.SQLCheck;
import pers.qingyu.sachima.sql.ast.statement.SQLCloseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLColumnCheck;
import pers.qingyu.sachima.sql.ast.statement.SQLColumnDefinition;
import pers.qingyu.sachima.sql.ast.statement.SQLColumnPrimaryKey;
import pers.qingyu.sachima.sql.ast.statement.SQLColumnReference;
import pers.qingyu.sachima.sql.ast.statement.SQLColumnUniqueKey;
import pers.qingyu.sachima.sql.ast.statement.SQLCommentStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCommitStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCopyFromStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateDatabaseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateFunctionStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateIndexStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateMaterializedViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateOutlineStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateProcedureStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateRoleStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateSequenceStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateTableGroupStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateTriggerStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateUserStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLCreateViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDeclareStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDefault;
import pers.qingyu.sachima.sql.ast.statement.SQLDeleteStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDescribeStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropCatalogStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropDatabaseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropEventStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropFunctionStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropIndexStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropLogFileGroupStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropMaterializedViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropOutlineStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropProcedureStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropResourceGroupStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropResourceStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropRoleStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropSequenceStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropServerStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropSynonymStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropTableGroupStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropTableSpaceStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropTriggerStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropTypeStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropUserStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDropViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLDumpStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLErrorLoggingClause;
import pers.qingyu.sachima.sql.ast.statement.SQLExplainAnalyzeStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLExplainStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLExportDatabaseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLExprHint;
import pers.qingyu.sachima.sql.ast.statement.SQLExprStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLExprTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLExternalRecordFormat;
import pers.qingyu.sachima.sql.ast.statement.SQLFetchStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLForStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLForeignKeyImpl;
import pers.qingyu.sachima.sql.ast.statement.SQLGrantStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLIfStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLImportDatabaseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLInsertStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLJoinTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLLateralViewTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLLoopStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLMergeStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLNotNullConstraint;
import pers.qingyu.sachima.sql.ast.statement.SQLNullConstraint;
import pers.qingyu.sachima.sql.ast.statement.SQLOpenStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLPartitionRef;
import pers.qingyu.sachima.sql.ast.statement.SQLPrimaryKeyImpl;
import pers.qingyu.sachima.sql.ast.statement.SQLPrivilegeItem;
import pers.qingyu.sachima.sql.ast.statement.SQLPurgeLogsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLPurgeRecyclebinStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLPurgeTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLPurgeTemporaryOutputStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLRefreshMaterializedViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLReleaseSavePointStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLRenameUserStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLReplaceStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLRestoreStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLReturnStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLRevokeStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLRollbackStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLSavePointStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLScriptCommitStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLSelect;
import pers.qingyu.sachima.sql.ast.statement.SQLSelectGroupByClause;
import pers.qingyu.sachima.sql.ast.statement.SQLSelectItem;
import pers.qingyu.sachima.sql.ast.statement.SQLSelectOrderByItem;
import pers.qingyu.sachima.sql.ast.statement.SQLSelectQueryBlock;
import pers.qingyu.sachima.sql.ast.statement.SQLSelectStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLSetStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowCatalogsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowColumnsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowCreateMaterializedViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowCreateTableStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowCreateViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowDatabasesStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowErrorsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowFunctionsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowGrantsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowIndexesStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowMaterializedViewStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowOutlinesStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowPackagesStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowProcessListStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowQueryTaskStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowRecylebinStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowSessionStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowTableGroupsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowTablesStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowUsersStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLShowViewsStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLStartTransactionStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLSubmitJobStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLSubqueryTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLSyncMetaStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLTableLike;
import pers.qingyu.sachima.sql.ast.statement.SQLTableSampling;
import pers.qingyu.sachima.sql.ast.statement.SQLTruncateStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLUnionQuery;
import pers.qingyu.sachima.sql.ast.statement.SQLUnionQueryTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLUnique;
import pers.qingyu.sachima.sql.ast.statement.SQLUnnestTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLUpdateSetItem;
import pers.qingyu.sachima.sql.ast.statement.SQLUpdateStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLUseStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLValuesQuery;
import pers.qingyu.sachima.sql.ast.statement.SQLValuesTableSource;
import pers.qingyu.sachima.sql.ast.statement.SQLWhileStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLWhoamiStatement;
import pers.qingyu.sachima.sql.ast.statement.SQLWithSubqueryClause;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.MySqlKillStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.SQLAlterResourceGroupStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.SQLCreateResourceGroupStatement;
import pers.qingyu.sachima.sql.dialect.mysql.ast.statement.SQLListResourceGroupStatement;
